...
let g:tmuxline_preset = {
    ...
    \ 'cwin' : ['#I', '#W', '#F'],
    \ 'x'    : ['%I:%M %p', '%D'],
    \ 'z'    : "Net:#(~/.tmux/plugins/tmux-online-status/scripts/online_status_icon.sh) #(~/.tmux/plugins/tmux-battery/scripts/battery_icon.sh):#(~/.tmux/plugins/tmux-battery/scripts/battery_percentage.sh) CPU:#(~/.tmux/plugins/tmux-cpu/scripts/cpu_percentage.sh)"
    \ }
